...
<div class="botfooter">
    <div class="leftbotfooter">
        <div class="logofooter"><img src="images/logowhite.png" alt="Logo de l'entreprise"></div>
        <p class="loanwarning">Un crédit vous engage et doit être remboursé. <br /> Vérifiez vos capacités de
            remboursement avant de vous engager.</p>
    </div>
    <div class="centerbotfooter">
    ...
    <div class="rightbotfooter">
        ...
        <p>Une réalisation <a href="https://promo-93.codeur.online/blog/" target="_blank" rel="noopener"
                class="credit">ACS Lons le Saunier</a></p>
    </div>
